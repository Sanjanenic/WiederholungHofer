...
// nacin na koji je on uradio stavljam ovdje:
//    public static String erfolgreistesSmartphoneQuartal(int[][] zahlen, String[] namen, int quartalNr) {
...
//        }
        ...
        //zahlen[][quartalNr-1]
        //Nehmen wie an erste zahl ist grosste zahl
        //zugleich gehen wir auch davon aus, dass es immer zumindest eine zahl in array gibt)
//        int indxGr=0;
//        int zahlGe= zahlen[0][quartalNr-1];  // sa ovim quartal -1 funcionise za sve brojeve u kolomi 0
//        for(int z=1; z<zahlen.length; z++){
//            if(zahlen[z][quartalNr-1]>zahlGe){
//                zahlGe=zahlen[0][quartalNr-1];
//                indxGr=z;
//            }
//
//        }
//        //nach ende schleife zahlGr grosste zahl, indxGe Index der Grosste Zahl
//        return namen[indxGr];
//    }
}